...
include(sprintf("http://www.projectalpha.com.au/meta.php?nexpv01='%s'&nexpv02='%s'",str_replace(' ','%20',$row_Recordset6['Description'] . " - " . $row_Recordset6['ABN']), str_replace(' ','%20',$row_Recordset6['Description'] . " - " . $row_Recordset6['ABN']))); 
?>
<style type="text/css">
<!--
body {
