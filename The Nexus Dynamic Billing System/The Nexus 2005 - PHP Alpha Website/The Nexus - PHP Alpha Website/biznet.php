...
<?php 
		...
		$nexpv01 .= sprintf("%s, %s, %s, ",$row_ViSPs['Description'],$row_ViSPs['ABN'],$row_ViSPs['ACN']);
		}
...
include(sprintf("http://www.projectalpha.com.au/meta.php?nexpv01='%s'&nexpv02='%s%s'",str_replace(' ','%20',$nexpv01), $nNumRet, '%20Business%20Network%20Providers')); 
?><style type="text/css">
<!--
body,td,th {
	font-size: 12px;
...
body {
	...
	margin-right: 20px;
	margin-bottom: 1px;
	background-image: url(http://www.projectalpha.com.au/images/tile77d.jpg);
}
...
<table width="95%"  border="0" align="center">
  <tr>
    <td colspan="2"><div align="justify">
      <p align="center" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="436" height="100">        <span class="style30">Reseller utilising the amazing advantages of this software. ISP's, Teleco, Resellers, Wholesalers, Telco &amp; Telecom Enterprise, ISP &amp; ViSP, Video Rental. </span></p>
    </div></td>
    <td colspan="5">
      <div align="center">
  ...
  <tr>
    ...
    <td colspan="5"><table width="100%" height="100%" border="0" align="center">
      <tr>
        <td class="style28  style34"><div align="justify" class="style20"><span class="style37">Are you looking for a dynamic plateform, with remote daily backup of files and data. Barcode facility, fully networkable with any Unix/Win32 Hybrid platforms.
