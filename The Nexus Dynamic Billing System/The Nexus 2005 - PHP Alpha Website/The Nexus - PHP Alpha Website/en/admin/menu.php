...
<table width="100%" border="0" cellspacing="1" cellpadding="4" bgcolor="#FFFFFF">
  ...
  <tr> 
    <td bgcolor="#F2F2F2"><a href="useradmin.php" target="mainFrame" class="en_b"><?php print "$admin_useradmin"; ?></a></td>
  </tr>  
  <tr> 
    <td bgcolor="#F2F2F2"><a href="searchuser.php" target="mainFrame" class="en_b"><?php print "$admin_search"; ?></a></td>
  </tr>
</table>
</body>
</html>
