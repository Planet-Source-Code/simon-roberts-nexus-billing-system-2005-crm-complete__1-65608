...
Begin VB.Form frmCLMLayout 
   ...
   ClientTop       =   2460
   ClientWidth     =   12915
   Icon            =   "frmCLMLayout_new.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   10875
...
Private Sub Command1_Click(Index As Integer)
    ...
    Call MySQL.Execute(directConn, SQL, False)
    ...
    Call MySQL.fillLV(directConn, rsload, lvColumn, True, IIf(Index = 0, lvColumn.SelectedItem, Nothing))
...
Private Sub Form_Load()
    ...
    Call MySQL.OpenTable(directConn, rsload, , "select * from columnlayout order by formcode, cOrder")
    
    Call MySQL.fillLV(directConn, rsload, lvColumn, False)
