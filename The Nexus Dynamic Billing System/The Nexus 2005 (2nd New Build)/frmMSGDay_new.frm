      ...
      Begin MSComctlLib.ImageList ilSysops 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMSGDay_new.frx":0000
               Key             =   "k100"
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMSGDay_new.frx":031A
               Key             =   "k080_099"
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMSGDay_new.frx":0634
               Key             =   "k060_079"
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMSGDay_new.frx":0F0E
               Key             =   "k040_059"
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMSGDay_new.frx":1360
               Key             =   "k001_020"
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMSGDay_new.frx":17B2
               Key             =   "k020_039"
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmMSGDay_new.frx":1C04
               Key             =   "k000"
            EndProperty
         EndProperty
      End
    ...
    If lvSysops.ListItems.Count > 0 Then
        ...
        For sa = 1 To lvSysops.ListItems.Count
            ...
            ElseIf Left(itmX.Key, 1) = "e" Then
                ...
                directConn.Execute "UPDATE sysops SET Password = AES_ENCRYPT('" & itmX.Tag & "','" + odb.colSalts.ReturnSalt(PWSalt) + "') where RecID = " & Mid(itmX.Key, 2)
    ...
    Case 0
        For lx = 1 To lvSysops.ListItems.Count
            If lvSysops.ListItems(lx).Checked = True Then
                MySQL.Execute directConn, "UPDATE sysops SET msg = '" & MySQL.ESC(txtMSG.Text) & "' where RecID = " & Mid(lvSysops.ListItems(lx).Key, 2)
            End If
        Next lx
    Case 1
...
Dim rsload As adodb.Recordset
    ...
    bResult = MySQL.OpenTable(directConn, rsload, , MySQL.virtualisp("select sysops.Checked, sysops.SecurityLevel, sysops.RecID, sysops.Username, sysops.description, decode(Password,'" + odb.colSalts.ReturnSalt(PWSalt) + "') as Password from sysops", "sysops"))
...
'
    ...
    If MySQL.OpenTable(directConn, rsMSG, , "select msg from sysops where RecID = " + Mid(Item.Key, 2)) = True Then
