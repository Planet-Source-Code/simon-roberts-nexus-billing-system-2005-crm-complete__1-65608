         ...
         Begin MSComctlLib.ImageList ilSysops 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmOptions_new.frx":030A
                  Key             =   "k100"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmOptions_new.frx":0624
                  Key             =   "k080_099"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmOptions_new.frx":093E
                  Key             =   "k060_079"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmOptions_new.frx":1218
                  Key             =   "k040_059"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmOptions_new.frx":166A
                  Key             =   "k001_020"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmOptions_new.frx":1ABC
                  Key             =   "k020_039"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmOptions_new.frx":1F0E
                  Key             =   "k000"
               EndProperty
            EndProperty
         End
    ...
    If lvSysops.ListItems.Count > 0 Then
        ...
        For sa = 1 To lvSysops.ListItems.Count
            ...
            If itmX.Key = "" Then
                ...
                'Call MySQL.OpenTable(directConn, rsSave, , "select * from sysops Limit 0")
                ...
                MySQL.Execute directConn, "INSERT INTO sysops (Username, Password, Description, Checked, SecurityLevel, VirtualID, bVISP)" + _
            ...
            ElseIf Left(itmX.Key, 1) = "e" Then
                ...
                Call MySQL.OpenTable(directConn, rsSave, , "select * from sysops where RecID = " & Mid(itmX.Key, 2) & " Limit 1")
                
                directConn.Execute "UPDATE sysops SET SecurityLevel = '" & CByte(itmX.Text) & "' where RecID = " & Mid(itmX.Key, 2)
                directConn.Execute "UPDATE sysops SET Username = '" & MySQL.ESC(itmX.SubItems(1)) & "' where RecID = " & Mid(itmX.Key, 2)
                directConn.Execute "UPDATE sysops SET Description = '" & MySQL.ESC(itmX.SubItems(2)) & "' where RecID = " & Mid(itmX.Key, 2)
                directConn.Execute "UPDATE sysops SET Checked = '" & IIf(itmX.Checked = True, "-1", "0") & "' where RecID = " & Mid(itmX.Key, 2)
                               
                directConn.Execute "UPDATE sysops SET Password = encode('" & itmX.Tag & "','" + odb.colSalts.ReturnSalt(PWSalt) + "') where RecID = " & Mid(itmX.Key, 2)
...
'
    ...
    bResult = MySQL.OpenTable(directConn, rsload, , MySQL.virtualisp("select distinct sysops.Checked ,sysops.SecurityLevel ,sysops.RecID ,sysops.Username ,sysops.Description from sysops ", "sysops", False, Login.bMaster))
