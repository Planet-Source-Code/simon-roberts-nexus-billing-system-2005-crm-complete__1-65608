   ...
   Begin VB.PictureBox picts 
      ...
      Begin MSComctlLib.ListView lvAddresses 
         ...
         BeginProperty ColumnHeader(7) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2540
         EndProperty
         Picture         =   "frmVendors_new.frx":030A
      End
   End
   Begin VB.PictureBox picts 
      BackColor       =   &H00EC7A71&
      ...
      Begin MSComctlLib.ListView lvPhone 
         ...
         BeginProperty ColumnHeader(4) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   2540
         EndProperty
         Picture         =   "frmVendors_new.frx":0F8D
      End
   End
   Begin VB.PictureBox picts 
      BackColor       =   &H00EC7A71&
      ...
      Begin MSComctlLib.ListView lvEmail 
         ...
         BeginProperty ColumnHeader(2) {BDD1F052-858B-11D1-B16A-00C0F0283628} 
            ...
            Object.Width           =   8819
         EndProperty
         Picture         =   "frmVendors_new.frx":166C
      End
   End
   Begin VB.PictureBox picts 
      BackColor       =   &H009191F4&
...
'    MsgBox "select `RecID`, " & sql1 & " from vendors"
    ...
    If MySQL.OpenTable(directConn, rsvendors, , MySQL.virtualisp("select distinct `vendors`.`RecID`, " & sql1 & " from vendors", "vendors", False, Login.bMaster)) = True Then
        
        
        
        Call MySQL.fillLV(directConn, rsvendors, lvVendors, False, , 1)
    ...
    If lvAddresses.ListItems.Count > 0 Then
        ...
        For sa = 1 To lvAddresses.ListItems.Count
            ...
            If itmX.Key = "" Then
                ...
                Do
                    Err.Clear
                    RecID = MySQL.GetTMPRecID("vendors_addresses", directConn)
                    Call MySQL.Execute(directConn, "INSERT INTO vendors_addresses (RecID, VendorID, ContactName, Street1, Street2, Suburb, State, PostCode, Country, Checked) " + _
            ...
            ElseIf Left(itmX.Key, 1) = "e" Then
                ...
                Call MySQL.OpenTable(directConn, rsSave, , "select * from visp_addresses where RecID = " & Mid(itmX.Key, 2) & " Limit 1")
                
                Call MySQL.Execute(directConn, "update vendors_addresses set ContactName = '" & MySQL.ESC(itmX.Text) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_addresses set Street1 = '" & MySQL.ESC(itmX.SubItems(1)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_addresses set Street2 = '" & MySQL.ESC(itmX.SubItems(2)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_addresses set Suburb = '" & MySQL.ESC(itmX.SubItems(3)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_addresses set State = '" & MySQL.ESC(itmX.SubItems(4)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_addresses set PostCode = '" & MySQL.ESC(itmX.SubItems(5)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_addresses set Country = '" & MySQL.ESC(itmX.SubItems(6)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_addresses set Checked = '" & IIf(itmX.Checked = True, "-1", "0") & " where RecID = " & Mid(itmX.Key, 2))
...
'
    ...
    If lvPhone.ListItems.Count > 0 Then
            ...
            If itmX.Key = "" Then
                ...
                Do
                    Err.Clear
                    RecID = MySQL.GetTMPRecID("vendors_phone", directConn)
                    Call MySQL.Execute(directConn, "INSERT INTO vendors_phone (RecID, VendorID, ContactName, PhoneNumber, Extension, ShortNote, Checked) " + _
            ...
            ElseIf Left(itmX.Key, 1) = "e" Then
                ...
                Call MySQL.Execute(directConn, "update vendors_phone set ContactName = '" & MySQL.ESC(itmX.Text) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_phone set PhoneNumber = '" & MySQL.ESC(itmX.SubItems(1)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_phone set Extension = '" & MySQL.ESC(itmX.SubItems(2)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_phone set ShortNote = '" & MySQL.ESC(itmX.SubItems(3)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_phone set Checked = '" & IIf(itmX.Checked = True, "-1", "0") & " where RecID = " & Mid(itmX.Key, 2))
...
'
    ...
    If lvEmail.ListItems.Count > 0 Then
            ...
            If itmX.Key = "" Then
                ...
                Do
                    Err.Clear
                    RecID = MySQL.GetTMPRecID("vendors_email", directConn)
                    Call MySQL.Execute(directConn, "INSERT INTO vendors_email (RecID, VendorID, ContactName, Emailaddress, Checked) " + _
            ...
            ElseIf Left(itmX.Key, 1) = "e" Then
                ...
                Call MySQL.Execute(directConn, "update vendors_email set ContactName = '" & MySQL.ESC(itmX.Text) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_email set Emailaddress = '" & MySQL.ESC(itmX.SubItems(1)) & " where RecID = " & Mid(itmX.Key, 2))
                Call MySQL.Execute(directConn, "update vendors_email set Checked = '" & IIf(itmX.Checked = True, "-1", "0") & " where RecID = " & Mid(itmX.Key, 2))
...
'
    ...
    Case 1 ' Save all
        If lvVendors.Tag = "" Then
            ...
            If txtField(0) = "" Then
                If Not frmAgent.oChar Is Nothing Then frmAgent.oChar.GestureAt 400, 400
                If Not frmAgent.oChar Is Nothing Then frmAgent.oChar.Play "Decline"
                If Not frmAgent.oChar Is Nothing Then frmAgent.oChar.Speak "You must enter the vendors name first."
                Exit Sub
            End If
            
            If txtField(1) = "" Or txtField(2) = "" Then
                If Not frmAgent.oChar Is Nothing Then frmAgent.oChar.GestureAt 500, 500
                If Not frmAgent.oChar Is Nothing Then frmAgent.oChar.Play "Decline"
                If Not frmAgent.oChar Is Nothing Then frmAgent.oChar.Speak "You must enter the vendors ABN or ACN, you can enter both if you wish."
                Exit Sub
            End If
            ...
            If Save = True Then
                ...
                If Not frmAgent.oChar Is Nothing Then frmAgent.oChar.Speak "Saving and encrypting new vendor '" & txtField(0) & "' to the server."
                
                On Error Resume Next
                Do
                    Err.Clear
                    VendorID = MySQL.GetTMPRecID("vendors", directConn)
                    lvVendors.Tag = VendorID
                    directConn.Execute "insert into vendors (`RecID`," & Left(SQLa, Len(SQLa) - 2) & ",VirtualID, SysopID) VALuES('" & VendorID & "'," & Left(SQLb, Len(SQLb) - 2) & ",'" & Login.lVirtualID & "','" & Login.lSysopID & "')"
        ...
        Else
            ...
            If Not frmAgent.oChar Is Nothing Then frmAgent.oChar.Play "Write"
            If Not frmAgent.oChar Is Nothing Then frmAgent.oChar.Speak "Saving and encrypting data to the server."
            ...
            MySQL.Execute directConn, "update vendors set " & Left(SQL, Len(SQL) - 2) & " where RecID = " & lvVendors.Tag
...
'
    ...
    If MySQL.OpenTable(directConn, rsload, , "select RecID, " & sql1 & " from vendors where RecID = " & Mid(Item.Key, 2)) = True Then
    ...
    bResult = MySQL.OpenTable(directConn, rsload, , "select * from vendors_addresses Where VendorID = " & Mid(Item.Key, 2))
    ...
    bResult = MySQL.OpenTable(directConn, rsload, , "select * from vendors_email Where VendorID = " & Mid(Item.Key, 2))
    ...
    bResult = MySQL.OpenTable(directConn, rsload, , "select * from vendors_phone Where VendorID = " & Mid(Item.Key, 2))
