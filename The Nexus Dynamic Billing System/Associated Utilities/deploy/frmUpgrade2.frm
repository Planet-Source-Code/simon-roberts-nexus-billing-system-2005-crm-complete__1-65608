...
Begin VB.Form frmUpgrade 
   ...
   Caption         =   "The Nexus Project - Deployment & Upgrade"
   ClientHeight    =   1485
   ClientLeft      =   3840
   ClientTop       =   4200
   ClientWidth     =   7395
   ...
   Begin CHILKATFTPLibCtl.ChilkatFTP cFTP 
      Left            =   8970
      OleObjectBlob   =   "frmUpgrade2.frx":1194
      Top             =   1380
   End
   Begin VB.Label ls 
      Alignment       =   2  'Center
...
Private Sub Form_Load()
    ...
    Me.Move Screen.Width - Me.Width - 240, Screen.Height - Me.Height - 560
