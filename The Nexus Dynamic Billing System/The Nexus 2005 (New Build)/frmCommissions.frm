...
Begin VB.Form frmCommissions 
         ...
         Begin MSComctlLib.ImageList ilSysops 
            ...
            BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
               ...
               BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmCommissions.frx":030A
                  Key             =   "k100"
               EndProperty
               BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmCommissions.frx":0624
                  Key             =   "k080_099"
               EndProperty
               BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmCommissions.frx":093E
                  Key             =   "k060_079"
               EndProperty
               BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmCommissions.frx":1218
                  Key             =   "k040_059"
               EndProperty
               BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmCommissions.frx":166A
                  Key             =   "k001_020"
               EndProperty
               BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmCommissions.frx":1ABC
                  Key             =   "k020_039"
               EndProperty
               BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
                  Picture         =   "frmCommissions.frx":1F0E
                  Key             =   "k000"
               EndProperty
            EndProperty
         End
   ...
   Begin VB.Image Image1 
      Height          =   690
      Left            =   90
      Picture         =   "frmCommissions.frx":2360
      Stretch         =   -1  'True
      Top             =   30
      Width           =   690
   End
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "Type in the new name for the commision class and press create otherwise use the down arrow to select which one you are working with."
        bPlay = True
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "After you have selected a plan or service to add in a commission scale node fill in the details contain withing the Rates frame and click on this green Add button."
        bPlay = True
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "IF you would like to add bonues to this group of scales click on this button and add in a bonus."
        bPlay = True
...
'
    ...
    If lvSysops(0).ListItems.Count > 0 Then
        ...
        Call MySQL.OpenTable(ADOConn, rsBonus_Units, , "select distinct * from bonus_units")
        ...
        For lx = 1 To lvSysops(0).ListItems.Count
            ...
            If MySQL.OpenTable(ADOConn, rsClass, , "select wrkPercent, CommClass, IncomeTax, SuperRate from sysops where RecID = " + Mid(lvSysops(0).ListItems(lx).Key, 2)) = True Then
                ...
                Else
                    ...
                    If lClassID <> 0 Then
                        For lY = 1 To lvPlans.ListItems.Count
                            If MySQL.OpenTable(ADOConn, rsCount, , "select count(*) as NumPlans from acci_services where SysopID = " & Mid(lvSysops(0).ListItems(lx).Key, 2) & " and ptRecID = " & Mid(lvPlans.ListItems(lY).Key, 2)) = True Then
                                ...
                                If MySQL.OpenTable(ADOConn, rsNum, , "select invoiceout.*, acci_services.ptRecID as ptRecID from invoiceout, acci_services where (invoiceout.Created >= " + Format(MonthView(0).Value, "yyyymmdd000001") + " and invoiceout.Created <= " + Format(MonthView(1).Value, "yyyymmdd240000") + ") and invoiceout.PlanServiceID = acci_services.RecID and acci_services.SysopID = " & Mid(lvSysops(0).ListItems(lx).Key, 2) & " and acci_services.ptRecID = " & Mid(lvPlans.ListItems(lY).Key, 2)) = True Then
                                    ...
                                    Else
                                        If rsNum.RecordCount > 0 Then
                                            ...
                                            If MySQL.OpenTable(ADOConn, rsCount, , "select CommPerUnit, Percentile from CommRates Where ClassID = " & lClassID & " and ptRecID = " & Mid(lvPlans.ListItems(lY).Key, 2) & " and Min >= " & lNumOf & " and Max =< " & lNumOf) = True Then
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "After you have selected the start and end time for the query on the master database, click this button and the forecaster will display how much commission the sysops in the list have recieved."
        bPlay = True
...
'
    ...
    If Trim(cmbClass.Text) <> "" Then
        ...
        Do
            Err.Clear
            iNum = MySQL.GetTMPRecID("commnames", ADOConn)
            MySQL.Execute ADOConn, "Insert into commnames (RecID, CommName, VirtualID) Values(" & iNum & ",'" & MySQL.ESC(cmbClass.Text) & "'," & Login.lVirtualID & ")"
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "After you have typed in the new name for the class of commission in the combo box to the left of this create button. This will be the name for this type of commission. It will add it to the list and allow you to select which type of commission you are working with."
        bPlay = True
...
'
    ...
    If oComm.colRates.Count > 0 Then
        ...
        For ix = 1 To oComm.colRates.Count
            ...
            Case 1
                MySQL.Execute ADOConn, "Insert Into commrates (ClassID, ptRecID, Min, Max, CommPerUnit, Percentile, VirtualID, sKey) " + _
                                        "VALUES ('" & oRate.ClassID & "','" & oRate.ptRecID & "','" & oRate.Min & "','" & oRate.Max & "','" & oRate.Rate & "','" & oRate.Percentile & "','" & Login.lVirtualID & "','" & oRate.Key & "')"
                oRate.Flag = 0
            Case 2
                MySQL.Execute ADOConn, "Update commrates Set " + _
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "Once you have finished adjusting rates and scales click on this button and the details will be saved to the database."
        bPlay = True
...
Static bPlay As Boolean
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "After you have selected a scales node and changed the details in this box, click on the update button."
        bPlay = True
...
'
    ...
    MySQL.Execute ADOConn, "UPDATE sysops Set CommRate = " & itxM.Tag & ", wrkPercent = " & IIf(itxM.Checked = True, -1, 0) & " where RecID = " & Mid(itxM.Key, 2)
Exit Sub
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "This is a list of commision classes, select the sysop that you want to assign a commission class to then select the commission class in this listview."
        bPlay = True
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "This is the list of services and plan that you can apply individual rate scales against."
        bPlay = True
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "Here is the list of scales that have been applied to the individual item that you have selected. To change a scale you have already added; select it then change the details and press the green update button."
        bPlay = True
...
If bDebug = True Then On Error GoTo 0 Else On Error GoTo ErrorOccur
    ...
    bResult = MySQL.OpenTable(ADOConn, rsSysops, , MySQL.virtualisp("select distinct * ,virtualisp.description as ViSPDesc from sysops ", "sysops", True) & " group by sysops.RecID")
...
If bDebug = True Then On Error GoTo 0 Else On Error GoTo ErrorOccur
    ...
    If MySQL.OpenTable(ADOConn, rsload, , MySQL.virtualisp("select distinct commnames.* from commnames,", "commnames", False, False)) = True Then
    ...
    If MySQL.OpenTable(ADOConn, rsload, , MySQL.virtualisp("select distinct commrates.* from commrates,", "commrates", False, False)) = True Then
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "The cost price of the service or plan selected, this is a static field it cannot be changed."
        bPlay = True
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "The marins in the sale of these items based on the default pricing of the service or plan selected, this is a static field it cannot be changed."
        bPlay = True
...
'
    ...
    If picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        bPlay1 = True
            frmAgent.oChar.Speak "This is the total commission percentage of that will be award to the sysop for the money generated in upkeep of the system's database."
        ...
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        bPlay2 = True
            frmAgent.oChar.Speak "This is the total amount awarded in the calculations of commission from the data collected during upkeep."
        ...
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        bPlay3 = True
            frmAgent.oChar.Speak "How much per item of service or plan to award to the sysop on this commision class, from the minimum to maximum count range."
...
'
    ...
    If picTSContainer(0).Visible = True Then
        ...
        Case 0
            ...
            frmAgent.oChar.StopAll
            frmAgent.oChar.GestureAt oXY.X, oXY.Y
            frmAgent.oChar.Speak "The lowest count to start from when calculating commissionable amounts."
        ...
        Case 1
            ...
            frmAgent.oChar.Speak "The highest count to end from when calculating commissionable amounts."
...
'
    ...
    If bPlay = False And picTSContainer(0).Visible = True Then
        ...
        frmAgent.oChar.StopAll
        frmAgent.oChar.GestureAt oXY.X, oXY.Y
        frmAgent.oChar.Speak "The recommended retail price of the service or plan selected, this is a static field it cannot be changed."
        bPlay = True
