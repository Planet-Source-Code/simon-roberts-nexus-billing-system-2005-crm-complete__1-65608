   ...
   Begin MSComctlLib.ImageList ilMessageIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMessages.frx":0442
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMessages.frx":0D1C
            Key             =   ""
         EndProperty
      EndProperty
   End
...
'
    ...
    If Not lvMessages.SelectedItem Is Nothing Then
        bResult = MySQL.OpenTable(ADOConn, rsLoad, , "select RecID, MessageDraft, HTMLDraft from autoMessages where RecID = " & Mid(lvMessages.SelectedItem.Key, 2))
...
'
    ...
    bResult = MySQL.OpenTable(ADOConn, rsLoad, , MySQL.virtualisp("select Description, RecID, MSGType from autoMessages"))
...
'
    ...
    bResult = MySQL.OpenTable(ADOConn, rsLoad, , "select MessageDraft, HTMLDraft from autoMessages where RecID = " & Mid(Item.Key, 2))
