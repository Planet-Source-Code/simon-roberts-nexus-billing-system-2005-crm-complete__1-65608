...
Begin VB.Form frmFTPAccount 
   ...
   Begin VB.Image Image1 
      Height          =   1080
      Left            =   30
      Picture         =   "frmFTPAccount.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1005
   End
...
'
    ...
    If lRecID <> 0 Then
        bResult = MySQL.OpenTable(ADOConn, rsload, , "select * from acci_services where RecID = " & lRecID)
    ...
    Case True
        ...
        bResult = MySQL.OpenTable(ADOConn, rsload, , "select plantypes.RecID from plantypes, servicetypes where servicetypes.ServiceKey = 'FTP' And plantypes.ServiceID = servicetypes.RecID")
        If rsload.RecordCount > 0 Then
            ...
            bResult = MySQL.OpenTable(ADOConn, rsload, , "select * from acci_services Where (" & sSQL & ") and Username Like '" & MySQL.ESC(txtField(1)) & "'")
