...
Begin VB.Form frmAlias 
   ...
   Begin VB.Image Image1 
      Height          =   1050
      Left            =   60
      Picture         =   "frmAlias_new.frx":B757A
      Stretch         =   -1  'True
      Top             =   60
      Width           =   1230
   End
...
If bDebug = True Then On Error GoTo 0 Else On Error GoTo ErrorOccur
    ...
    If Not lvAlias.SelectedItem Is Nothing Then
        ...
        Case vbYes
            ...
            Else
                MySQL.Execute directConn, "Delete from acci_aliases where RecID = " & Mid(lvAlias.SelectedItem.Key, 2)
                lvAlias.ListItems.Remove lvAlias.SelectedItem.Index
            End If
        End Select
    End If
