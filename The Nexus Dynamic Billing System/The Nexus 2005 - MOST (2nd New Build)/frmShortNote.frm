...
Begin VB.Form frmShortNote 
   ...
   End
End
Attribute VB_Name = "frmShortNote"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public sShortNote As String
...
Private Sub Form_Load()
    ...
    Const ContainerName = "frmShortNote"
    '***************************************************************************************************************
...
'
    ...
    lblDescription = IIf(sDescription = "", "Short Note", sDescription)
    
    Text1.Text = sShortNote
